...
def getLeaderboard(request):
    ...
    ws.write(row_num,0,'Leaderboard',font_style)
    
    columns = ['UserId','User','Score','Rank']
    ...
    junior_query = Team.objects.filter(isJunior=True).order_by("-score", "lastUpdate").values_list('teamId','user1__username','score','lastUpdate')
